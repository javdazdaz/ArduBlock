  ...
  },
{
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "Elige el pin y la nota musical de listas.",
    "helpUrl": ""
  },
{
    "type": "tone_duration_basic",
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "Elige el pin, la nota musical y la duración de listas.",
    "helpUrl": ""
  },
{
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "El pin y la frecuencia pueden ser variables o expresiones. Permite melodías dinámicas desde arreglos.",
    "helpUrl": ""
  },
{
    "message0": Blockly.Msg.MSG_TONE_DURATION,
  ...
  },
{
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "El pin, frecuencia y duración pueden ser variables o expresiones. Permite melodías completamente dinámicas.",
    "helpUrl": ""
  },
{
  ...
  },
{
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "El pin puede ser una variable o expresión. Permite detener tonos en pines dinámicos.",
    "helpUrl": ""
  },
{
  ...
  },
{
    ...
    "output": "Number",
    "colour": 180,
    "tooltip": "El pin y el timeout pueden ser variables o expresiones. Permite medición de pulsos con parámetros dinámicos.",
    "helpUrl": ""
  },
{
    "type": "pulse_in_basic",
    ...
    "output": "Number",
    "colour": 180,
    "tooltip": "Elige el pin de una lista para medir la duración de un pulso en microsegundos.",
    "helpUrl": ""
  },
{
    "type": "attach_interrupt_basic",
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "Elige el pin de interrupción de una lista (solo pines 2 y 3 en Arduino Uno).",
    "helpUrl": ""
  },
{
    "message0": Blockly.Msg.MSG_ATTACH_INTERRUPT,
  ...
  },
{
    ...
    "nextStatement": null,
    "colour": 180,
    "tooltip": "El pin de interrupción puede ser una variable. Permite configurar interrupciones en pines dinámicos.",
    "helpUrl": ""
  }
];
...
// ── tone_duration_basic (N1) ───────────────────
cppGenerator.forBlock['tone_duration_basic'] = function(block) {
  const pin  = block.getFieldValue('PIN');
  const freq = block.getFieldValue('FREQ');
...
cppGenerator.forBlock['attach_interrupt_basic'] = function(block) {
  const pin  = block.getFieldValue('PIN');
