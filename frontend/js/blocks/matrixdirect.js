...
export const blocks = [
  // ── matrixdirect_create ────────────────────
  {
    ...
    args1: [
      { type: 'input_value', name: 'R1', align: 'RIGHT' },
      { type: 'input_value', name: 'R2', align: 'RIGHT' },
      { type: 'input_value', name: 'R3', align: 'RIGHT' },
      { type: 'input_value', name: 'R4', align: 'RIGHT' },
    ],
    args2: [
      { type: 'input_value', name: 'R5', align: 'RIGHT' },
      { type: 'input_value', name: 'R6', align: 'RIGHT' },
      { type: 'input_value', name: 'R7', align: 'RIGHT' },
      { type: 'input_value', name: 'R8', align: 'RIGHT' },
    ],
    args3: [
      { type: 'input_value', name: 'C1', align: 'RIGHT' },
      { type: 'input_value', name: 'C2', align: 'RIGHT' },
      { type: 'input_value', name: 'C3', align: 'RIGHT' },
      { type: 'input_value', name: 'C4', align: 'RIGHT' },
    ],
    args4: [
      { type: 'input_value', name: 'C5', align: 'RIGHT' },
      { type: 'input_value', name: 'C6', align: 'RIGHT' },
      { type: 'input_value', name: 'C7', align: 'RIGHT' },
      { type: 'input_value', name: 'C8', align: 'RIGHT' },
    ],
