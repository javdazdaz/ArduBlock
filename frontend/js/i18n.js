...
const messages = {
  es: {
    ...
    MSG_DIRECT_CREATE: 'iniciar matriz directa 8×8',
    TOOLTIP_DIRECT_CREATE: 'Inicializa una matriz LED 8×8 conectada directamente al Arduino (sin driver). Usa 16 pines: filas D10-A3, columnas D2-D9.',
  ...
  en: {
    ...
    MSG_DIRECT_CREATE: 'init direct 8×8 matrix',
    TOOLTIP_DIRECT_CREATE: 'Initializes an 8×8 LED matrix connected directly to Arduino pins (no driver chip). Uses 16 pins: rows D10-A3, columns D2-D9.',
