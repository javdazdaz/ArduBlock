...
const messages = {
  es: {
    ...
    MSG_ANALOG_WRITE: 'escribir analógico pin %1 valor %2',
    ...
    TOOLTIP_INCLUDE_HEADER: 'Incluye un archivo .h del proyecto. Creá el archivo en la barra de tabs.',
    MSG_LIBRARY_INCLUDE: 'incluir librería %1',
    TOOLTIP_LIBRARY_INCLUDE: 'Incluye una librería de Arduino en el sketch.',
    // ── AFMotor R4 ──
  ...
  en: {
    ...
    MSG_ANALOG_WRITE: 'analog write pin %1 value %2',
    ...
    TOOLTIP_INCLUDE_HEADER: 'Includes a .h file from the project. Create it in the tabs bar.',
    MSG_LIBRARY_INCLUDE: 'include library %1',
    TOOLTIP_LIBRARY_INCLUDE: 'Includes an Arduino library in the sketch.',
    // ── AFMotor R4 ──
    CAT_AFMOTOR: 'Motor AF',
