/**
 * Actividad 2.2 — Detenerse ante obstáculo
 *
 * Si el sensor detecta un obstáculo a menos de 15 cm, detenerse
 */

export const activity = {
  "name": "2.2 \u2014 Detenerse ante obst\u00e1culo",
  "description": "Si el sensor detecta un obst\u00e1culo a menos de 15 cm, detenerse",
  "state": {
    "blocks": {
      "languageVersion": 0,
      "blocks": [
  ...
  "activityMeta": {
    "title": "2.2 \u2014 Detenerse ante obst\u00e1culo",
    "protected": [
      "S1",
      "L1",
      "S1_LIB",
