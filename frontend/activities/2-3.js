/**
 * Actividad 2.3 — Retroceder al detectar
 *
 * Al detectar obstáculo: detener → retroceder 1s → avanzar
 */

export const activity = {
  "name": "2.3 \u2014 Retroceder al detectar",
  "description": "Al detectar obst\u00e1culo: detener \u2192 retroceder 1s \u2192 avanzar",
  "state": {
    "blocks": {
      "languageVersion": 0,
      "blocks": [
  ...
  "activityMeta": {
    "title": "2.3 \u2014 Retroceder al detectar",
    "protected": [
      "S1",
      "L1",
      "S1_LIB",
