/**
 * Actividad 2.5 — Auto explorador
 *
 * Usa random() para elegir dirección de giro al detectar obstáculo
 */

export const activity = {
  "name": "2.5 \u2014 Auto explorador",
  "description": "Usa random() para elegir direcci\u00f3n de giro al detectar obst\u00e1culo",
  "state": {
    "blocks": {
      "languageVersion": 0,
      "blocks": [
