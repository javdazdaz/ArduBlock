...
MESSAGES = {
    "es": {
        ...
        "clone_activity": "Clonar",
        "activity_cloned": "Actividad clonada a tu cuenta.",
        "activity_no_reference": "Esta actividad no tiene proyecto de referencia.",
    ...
    "en": {
        ...
        "clone_activity": "Clone",
        "activity_cloned": "Activity cloned to your account.",
        "activity_no_reference": "This activity has no reference project.",
