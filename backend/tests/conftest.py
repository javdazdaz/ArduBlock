...
from backend.models import User, Classroom, ClassroomStudent, Project, ProjectRevision, ProjectFile, ProjectFileOperation, ProjectBlockOperation, ProjectCollaborator, Class, Activity, ClassActivity  # noqa: E402
...
def clean_db(app):
    ...
    with app.app_context():
        ...
        try:
            ...
            s.query(ProjectBlockOperation).delete()
            s.query(ProjectCollaborator).delete()
